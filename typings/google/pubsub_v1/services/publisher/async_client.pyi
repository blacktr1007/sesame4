...
class PublisherAsyncClient:
    ...
    get_transport_class = ...
    def __init__(self, *, credentials: ga_credentials.Credentials = ..., transport: Union[str, PublisherTransport] = ..., client_options: ClientOptions = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    async def create_topic(self, request: Union[pubsub.Topic, dict] = ..., *, name: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Topic:
    ...
    async def update_topic(self, request: Union[pubsub.UpdateTopicRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Topic:
    ...
    async def publish(self, request: Union[pubsub.PublishRequest, dict] = ..., *, topic: str = ..., messages: Sequence[pubsub.PubsubMessage] = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.PublishResponse:
    ...
    async def get_topic(self, request: Union[pubsub.GetTopicRequest, dict] = ..., *, topic: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Topic:
    ...
    async def list_topics(self, request: Union[pubsub.ListTopicsRequest, dict] = ..., *, project: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListTopicsAsyncPager:
    ...
    async def list_topic_subscriptions(self, request: Union[pubsub.ListTopicSubscriptionsRequest, dict] = ..., *, topic: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListTopicSubscriptionsAsyncPager:
    ...
    async def list_topic_snapshots(self, request: Union[pubsub.ListTopicSnapshotsRequest, dict] = ..., *, topic: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListTopicSnapshotsAsyncPager:
    ...
    async def delete_topic(self, request: Union[pubsub.DeleteTopicRequest, dict] = ..., *, topic: str = ..., retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def detach_subscription(self, request: Union[pubsub.DetachSubscriptionRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.DetachSubscriptionResponse:
    ...
    async def set_iam_policy(self, request: iam_policy_pb2.SetIamPolicyRequest = ..., *, retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> policy_pb2.Policy:
    ...
    async def get_iam_policy(self, request: iam_policy_pb2.GetIamPolicyRequest = ..., *, retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> policy_pb2.Policy:
    ...
    async def test_iam_permissions(self, request: iam_policy_pb2.TestIamPermissionsRequest = ..., *, retry: OptionalRetry = ..., timeout: TimeoutType = ..., metadata: Sequence[Tuple[str, str]] = ...) -> iam_policy_pb2.TestIamPermissionsResponse:
    ...
    async def __aenter__(self): # -> Self@PublisherAsyncClient:
        ...
