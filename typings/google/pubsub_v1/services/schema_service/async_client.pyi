...
class SchemaServiceAsyncClient:
    ...
    get_transport_class = ...
    def __init__(self, *, credentials: ga_credentials.Credentials = ..., transport: Union[str, SchemaServiceTransport] = ..., client_options: ClientOptions = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    async def create_schema(self, request: Union[gp_schema.CreateSchemaRequest, dict] = ..., *, parent: str = ..., schema: gp_schema.Schema = ..., schema_id: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> gp_schema.Schema:
        r"""Creates a schema.
    ...
    async def get_schema(self, request: Union[schema.GetSchemaRequest, dict] = ..., *, name: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> schema.Schema:
        r"""Gets a schema.
    ...
    async def list_schemas(self, request: Union[schema.ListSchemasRequest, dict] = ..., *, parent: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListSchemasAsyncPager:
    ...
    async def delete_schema(self, request: Union[schema.DeleteSchemaRequest, dict] = ..., *, name: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
        r"""Deletes a schema.
    ...
    async def validate_schema(self, request: Union[gp_schema.ValidateSchemaRequest, dict] = ..., *, parent: str = ..., schema: gp_schema.Schema = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> gp_schema.ValidateSchemaResponse:
    ...
    async def validate_message(self, request: Union[schema.ValidateMessageRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> schema.ValidateMessageResponse:
    ...
    async def __aenter__(self): # -> Self@SchemaServiceAsyncClient:
        ...
