...
class SubscriberAsyncClient:
    ...
    @classmethod
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = ...): # -> tuple[Unknown | DEFAULT_MTLS_ENDPOINT | Literal['pubsub.googleapis.com'], Unknown | None]:
    ...
    get_transport_class = ...
    def __init__(self, *, credentials: ga_credentials.Credentials = ..., transport: Union[str, SubscriberTransport] = ..., client_options: ClientOptions = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    async def create_subscription(self, request: Union[pubsub.Subscription, dict] = ..., *, name: str = ..., topic: str = ..., push_config: pubsub.PushConfig = ..., ack_deadline_seconds: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    async def get_subscription(self, request: Union[pubsub.GetSubscriptionRequest, dict] = ..., *, subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    async def update_subscription(self, request: Union[pubsub.UpdateSubscriptionRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    async def list_subscriptions(self, request: Union[pubsub.ListSubscriptionsRequest, dict] = ..., *, project: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListSubscriptionsAsyncPager:
    ...
    async def delete_subscription(self, request: Union[pubsub.DeleteSubscriptionRequest, dict] = ..., *, subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def modify_ack_deadline(self, request: Union[pubsub.ModifyAckDeadlineRequest, dict] = ..., *, subscription: str = ..., ack_ids: Sequence[str] = ..., ack_deadline_seconds: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def acknowledge(self, request: Union[pubsub.AcknowledgeRequest, dict] = ..., *, subscription: str = ..., ack_ids: Sequence[str] = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def pull(self, request: Union[pubsub.PullRequest, dict] = ..., *, subscription: str = ..., return_immediately: bool = ..., max_messages: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.PullResponse:
    ...
    def streaming_pull(self, requests: AsyncIterator[pubsub.StreamingPullRequest] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> Awaitable[AsyncIterable[pubsub.StreamingPullResponse]]:
    ...
    async def modify_push_config(self, request: Union[pubsub.ModifyPushConfigRequest, dict] = ..., *, subscription: str = ..., push_config: pubsub.PushConfig = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def get_snapshot(self, request: Union[pubsub.GetSnapshotRequest, dict] = ..., *, snapshot: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    async def list_snapshots(self, request: Union[pubsub.ListSnapshotsRequest, dict] = ..., *, project: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListSnapshotsAsyncPager:
    ...
    async def create_snapshot(self, request: Union[pubsub.CreateSnapshotRequest, dict] = ..., *, name: str = ..., subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    async def update_snapshot(self, request: Union[pubsub.UpdateSnapshotRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    async def delete_snapshot(self, request: Union[pubsub.DeleteSnapshotRequest, dict] = ..., *, snapshot: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def seek(self, request: Union[pubsub.SeekRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.SeekResponse:
    ...
    async def set_iam_policy(self, request: iam_policy_pb2.SetIamPolicyRequest = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> policy_pb2.Policy:
    ...
    async def get_iam_policy(self, request: iam_policy_pb2.GetIamPolicyRequest = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> policy_pb2.Policy:
    ...
    async def test_iam_permissions(self, request: iam_policy_pb2.TestIamPermissionsRequest = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> iam_policy_pb2.TestIamPermissionsResponse:
    ...
    async def __aenter__(self): # -> Self@SubscriberAsyncClient:
        ...
