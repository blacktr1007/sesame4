...
class SubscriberClientMeta(type):
    ...
    objects.
    """
    _transport_registry: Dict[str, Type[SubscriberTransport]] = ...
    def get_transport_class(cls, label: str = ...) -> Type[SubscriberTransport]:
...
class SubscriberClient(metaclass=SubscriberClientMeta):
    ...
    @classmethod
    def from_service_account_info(cls, info: dict, *args, **kwargs): # -> Self@SubscriberClient:
    ...
    @classmethod
    def from_service_account_file(cls, filename: str, *args, **kwargs): # -> Self@SubscriberClient:
        """Creates an instance of this client using the provided credentials
            file.
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials] = ..., transport: Union[str, SubscriberTransport, None] = ..., client_options: Optional[client_options_lib.ClientOptions] = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    def create_subscription(self, request: Union[pubsub.Subscription, dict] = ..., *, name: str = ..., topic: str = ..., push_config: pubsub.PushConfig = ..., ack_deadline_seconds: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    def get_subscription(self, request: Union[pubsub.GetSubscriptionRequest, dict] = ..., *, subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    def update_subscription(self, request: Union[pubsub.UpdateSubscriptionRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Subscription:
    ...
    def list_subscriptions(self, request: Union[pubsub.ListSubscriptionsRequest, dict] = ..., *, project: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListSubscriptionsPager:
    ...
    def delete_subscription(self, request: Union[pubsub.DeleteSubscriptionRequest, dict] = ..., *, subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    def modify_ack_deadline(self, request: Union[pubsub.ModifyAckDeadlineRequest, dict] = ..., *, subscription: str = ..., ack_ids: Sequence[str] = ..., ack_deadline_seconds: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    def acknowledge(self, request: Union[pubsub.AcknowledgeRequest, dict] = ..., *, subscription: str = ..., ack_ids: Sequence[str] = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    def pull(self, request: Union[pubsub.PullRequest, dict] = ..., *, subscription: str = ..., return_immediately: bool = ..., max_messages: int = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.PullResponse:
    ...
    def streaming_pull(self, requests: Iterator[pubsub.StreamingPullRequest] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> Iterable[pubsub.StreamingPullResponse]:
    ...
    def modify_push_config(self, request: Union[pubsub.ModifyPushConfigRequest, dict] = ..., *, subscription: str = ..., push_config: pubsub.PushConfig = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    def get_snapshot(self, request: Union[pubsub.GetSnapshotRequest, dict] = ..., *, snapshot: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    def list_snapshots(self, request: Union[pubsub.ListSnapshotsRequest, dict] = ..., *, project: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListSnapshotsPager:
    ...
    def create_snapshot(self, request: Union[pubsub.CreateSnapshotRequest, dict] = ..., *, name: str = ..., subscription: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    def update_snapshot(self, request: Union[pubsub.UpdateSnapshotRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.Snapshot:
    ...
    def delete_snapshot(self, request: Union[pubsub.DeleteSnapshotRequest, dict] = ..., *, snapshot: str = ..., retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    def seek(self, request: Union[pubsub.SeekRequest, dict] = ..., *, retry: OptionalRetry = ..., timeout: float = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pubsub.SeekResponse:
    ...
    def __enter__(self): # -> Self@SubscriberClient:
        ...
