...
class SubscriberGrpcAsyncIOTransport(SubscriberTransport):
    ...
    @property
    def create_subscription(self) -> Callable[[pubsub.Subscription], Awaitable[pubsub.Subscription]]:
    ...
    @property
    def get_subscription(self) -> Callable[[pubsub.GetSubscriptionRequest], Awaitable[pubsub.Subscription]]:
    ...
    @property
    def update_subscription(self) -> Callable[[pubsub.UpdateSubscriptionRequest], Awaitable[pubsub.Subscription]]:
    ...
    @property
    def list_subscriptions(self) -> Callable[[pubsub.ListSubscriptionsRequest], Awaitable[pubsub.ListSubscriptionsResponse]]:
    ...
    @property
    def delete_subscription(self) -> Callable[[pubsub.DeleteSubscriptionRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def modify_ack_deadline(self) -> Callable[[pubsub.ModifyAckDeadlineRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def acknowledge(self) -> Callable[[pubsub.AcknowledgeRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def streaming_pull(self) -> Callable[[pubsub.StreamingPullRequest], Awaitable[pubsub.StreamingPullResponse]]:
    ...
    @property
    def modify_push_config(self) -> Callable[[pubsub.ModifyPushConfigRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_snapshot(self) -> Callable[[pubsub.GetSnapshotRequest], Awaitable[pubsub.Snapshot]]:
    ...
    @property
    def list_snapshots(self) -> Callable[[pubsub.ListSnapshotsRequest], Awaitable[pubsub.ListSnapshotsResponse]]:
    ...
    @property
    def create_snapshot(self) -> Callable[[pubsub.CreateSnapshotRequest], Awaitable[pubsub.Snapshot]]:
    ...
    @property
    def update_snapshot(self) -> Callable[[pubsub.UpdateSnapshotRequest], Awaitable[pubsub.Snapshot]]:
    ...
    @property
    def delete_snapshot(self) -> Callable[[pubsub.DeleteSnapshotRequest], Awaitable[empty_pb2.Empty]]:
