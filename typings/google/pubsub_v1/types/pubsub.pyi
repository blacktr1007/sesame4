...
class ListTopicsResponse(proto.Message):
    ...
    """
    @property
    def raw_page(self): # -> Self@ListTopicsResponse:
        ...
...
class ListTopicSubscriptionsResponse(proto.Message):
    ...
    """
    @property
    def raw_page(self): # -> Self@ListTopicSubscriptionsResponse:
        ...
...
class ListTopicSnapshotsResponse(proto.Message):
    ...
    """
    @property
    def raw_page(self): # -> Self@ListTopicSnapshotsResponse:
        ...
...
class ListSubscriptionsResponse(proto.Message):
    ...
    """
    @property
    def raw_page(self): # -> Self@ListSubscriptionsResponse:
        ...
...
class ListSnapshotsResponse(proto.Message):
    ...
    """
    @property
    def raw_page(self): # -> Self@ListSnapshotsResponse:
        ...
