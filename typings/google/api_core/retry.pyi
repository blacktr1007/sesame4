...
_DEFAULT_DEADLINE = ...
def if_exception_type(*exception_types): # -> (exception: Unknown) -> bool:
...
if_transient_error = ...
def exponential_sleep_generator(initial, maximum, multiplier=...): # -> Generator[float, None, None]:
...
class Retry:
    ...
    def __call__(self, func, on_error=...): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
    ...
    def with_deadline(self, deadline): # -> Retry:
    ...
    def with_predicate(self, predicate): # -> Retry:
    ...
    def with_delay(self, initial=..., maximum=..., multiplier=...): # -> Retry:
