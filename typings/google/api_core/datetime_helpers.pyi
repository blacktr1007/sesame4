...
class DatetimeWithNanoseconds(datetime.datetime):
    ...
    """
    __slots__ = ...
    def __new__(cls, *args, **kw): # -> Self@DatetimeWithNanoseconds:
        ...
    ...
    @classmethod
    def from_rfc3339(cls, stamp): # -> Self@DatetimeWithNanoseconds:
    ...
    @classmethod
    def from_timestamp_pb(cls, stamp): # -> Self@DatetimeWithNanoseconds:
        """Parse RFC3339-compliant timestamp, preserving nanoseconds.
