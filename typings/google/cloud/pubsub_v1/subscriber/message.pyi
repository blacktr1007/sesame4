...
class Message:
    ...
    """
    def __init__(self, message: types.PubsubMessage._meta._pb, ack_id: str, delivery_attempt: int, request_queue: queue.Queue, exactly_once_delivery_enabled_func: Callable[[], bool] = ...) -> None:
