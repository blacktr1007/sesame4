...
class Client(subscriber_client.SubscriberClient):
    ...
    def subscribe(self, subscription: str, callback: Callable[[subscriber.message.Message], Any], flow_control: Union[types.FlowControl, Sequence] = ..., scheduler: Optional[subscriber.scheduler.ThreadScheduler] = ..., use_legacy_flow_control: bool = ..., await_callbacks_on_shutdown: bool = ...) -> futures.StreamingPullFuture:
