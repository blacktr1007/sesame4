...
class CHSesame2(SesameLocker):
    ...
    def subscribeMechStatus(self, callback: Optional[Callable[[CHSesame2, CHSesame2MechStatus], None]] = ...) -> None:
    ...
    def lock(self, history_tag: str = ...) -> bool:
        """Locking.
    ...
    def unlock(self, history_tag: str = ...) -> bool:
        """Unlocking.
    ...
    def toggle(self, history_tag: str = ...) -> bool:
        """Toggle.
